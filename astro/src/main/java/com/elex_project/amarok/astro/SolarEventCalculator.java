package com.elex_project.amarok.astro;
...
public class SolarEventCalculator {
	...
	private @Nullable BigDecimal computeSolarEventTime(Zenith solarZenith, @NotNull Calendar date, boolean isSunrise) {
	 ...
	 */
	private BigDecimal getLongitudeHour(Calendar date, @NotNull Boolean isSunrise) {
		int offset = 18;
		if (isSunrise) {
			offset = 6;
		}
	...
	private BigDecimal getSunTrueLongitude(BigDecimal meanAnomaly) {
		...
		BigDecimal sinDoubleMeanAnomaly = BigDecimal.valueOf(Math.sin(multiplyBy(convertDegreesToRadians(meanAnomaly), BigDecimal.valueOf(2))
				.doubleValue()));
	...
	private BigDecimal getCosineOfSunDeclination(@NotNull BigDecimal sinSunDeclination) {
	...
	private BigDecimal getSunLocalHour(BigDecimal cosineSunLocalHour, @NotNull Boolean isSunrise) {
	...
	private BigDecimal getLocalMeanTime(BigDecimal sunTrueLong, @NotNull BigDecimal longitudeHour, @NotNull BigDecimal sunLocalHour) {
	...
	private BigDecimal getLocalTime(@NotNull BigDecimal localMeanTime, Calendar date) {
	...
	private BigDecimal adjustForDST(BigDecimal localMeanTime, @NotNull Calendar date) {
	 ...
	 */
	private @NotNull String getLocalTimeAsString(BigDecimal localTimeParam) {
